...
| R4.9 | Multi-county scope spans eight North Atlanta and North Georgia counties (Gwinnett, Fulton, Forsyth, DeKalb, Cobb, Cherokee, Hall, Dawson). For Fulton, DeKalb, and Cobb, coverage strictly adheres to the North Atlanta boundary (north of the top-end Perimeter / I-285 corridor). | Curated regional discovery |
